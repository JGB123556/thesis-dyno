...
void setup()  // Start of setup:
{
  ...
  delay(10000);  // We sometimes take several readings of the period to average. Since we don't have any readings
...
void Pulse_Event()  // The interrupt runs this to calculate the period between pulses:
{
  ...
  if(PulseCounter >= AmountOfReadings)  // If counter for amount of readings reach the set limit:
  {
    ...
    AmountOfReadings = RemappedAmountOfReadings;  // Set amount of readings as the remapped value.
  }
  else
  {
